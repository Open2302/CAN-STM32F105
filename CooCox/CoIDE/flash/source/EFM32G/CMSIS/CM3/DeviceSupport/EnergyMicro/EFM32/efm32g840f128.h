/**************************************************************************//**
 * @file
 * @brief CMSIS Cortex-M3 Peripheral Access Layer for EFM EFM32G840F128
...
/**************************************************************************//**
 *
 * @addtogroup EFM32G840F128_TIMER
 * @{
 *****************************************************************************/
typedef struct
{
...
/**************************************************************************//**
 *
 * @addtogroup EFM32G840F128_USART
 * @{
 *****************************************************************************/
typedef struct
{
...
/**************************************************************************//**
 *
 * @addtogroup EFM32G840F128_LEUART
 * @{
 *****************************************************************************/
typedef struct
{
...
/**************************************************************************//**
 *
 * @addtogroup EFM32G840F128_LETIMER
 * @{
 *****************************************************************************/
typedef struct
{
...
/**************************************************************************//**
 *
 * @addtogroup EFM32G840F128_DEVINFO
 * @{
 *****************************************************************************/
typedef struct
{
...
/**************************************************************************//**
 *
 * @addtogroup EFM32G840F128_CALIBRATE
 * @{
 *****************************************************************************/
...
/**************************************************************************//**
 *
 * @defgroup EFM32G840F128_Peripheral_Base EFM32G840F128 Peripheral Base Addresses
 * @{
 *****************************************************************************/
...
/**************************************************************************//**
 *
 * @defgroup EFM32G840F128_Peripheral_Declaration  EFM32G840F128 Peripheral Declaration
 * @{
 *****************************************************************************/
...
/**************************************************************************//**
 *
 * @defgroup EFM32G840F128_DMA_Channel_Select EFM32G840F128 DMA Channel Select
 * @{
 *****************************************************************************/
...
#define USART_ROUTE_CLKPEN                    (0x1UL << 3)        /**< RX Pin Enable */
...
#define LEUART_CTRL_ERRSDMA                      (0x1UL << 6)         /**< Halt RX DMA On Error */
...
#define I2C_IF_CLTO                       (0x1UL << 15)        /**< Clock Low Interrupt Flag */
...
#define ADC_SINGLECTRL_SINGLEREP                (0x1UL << 0)         /**< Single Sample Repetitive Mode */
...
#define ADC_SINGLECTRL_SINGLEDIFF               (0x1UL << 1)         /**< Single Sample Differential Mode */
...
#define ADC_SINGLECTRL_SINGLEADJ                (0x1UL << 2)         /**< Single Sample Result Adjustment */
...
#define ADC_SINGLECTRL_SINGLESEL_CH0            (0x00000000UL << 8)  /**< Shifted mode CH0 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH0CH1         (0x00000000UL << 8)  /**< Shifted mode CH0CH1 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH1            (0x00000001UL << 8)  /**< Shifted mode CH1 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH2CH3         (0x00000001UL << 8)  /**< Shifted mode CH2CH3 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH2            (0x00000002UL << 8)  /**< Shifted mode CH2 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH4CH5         (0x00000002UL << 8)  /**< Shifted mode CH4CH5 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH6CH7         (0x00000003UL << 8)  /**< Shifted mode CH6CH7 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH3            (0x00000003UL << 8)  /**< Shifted mode CH3 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH4            (0x00000004UL << 8)  /**< Shifted mode CH4 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_DIFF0          (0x00000004UL << 8)  /**< Shifted mode DIFF0 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH5            (0x00000005UL << 8)  /**< Shifted mode CH5 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH6            (0x00000006UL << 8)  /**< Shifted mode CH6 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_CH7            (0x00000007UL << 8)  /**< Shifted mode CH7 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_TEMP           (0x00000008UL << 8)  /**< Shifted mode TEMP for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_VDDDIV3        (0x00000009UL << 8)  /**< Shifted mode VDDDIV3 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_VDD            (0x0000000AUL << 8)  /**< Shifted mode VDD for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_VSS            (0x0000000BUL << 8)  /**< Shifted mode VSS for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_VREFDIV2       (0x0000000CUL << 8)  /**< Shifted mode VREFDIV2 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_DACOUT0        (0x0000000DUL << 8)  /**< Shifted mode DACOUT0 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_DACOUT1        (0x0000000EUL << 8)  /**< Shifted mode DACOUT1 for ADC_SINGLECTRL */
#define ADC_SINGLECTRL_SINGLESEL_ATESTIN        (0x0000000FUL << 8)  /**< Shifted mode ATESTIN for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_DEFAULT       0x00000000UL         /**< Mode DEFAULT for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH0           0x00000000UL         /**< Mode CH0 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH0CH1        0x00000000UL         /**< Mode CH0CH1 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH1           0x00000001UL         /**< Mode CH1 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH2CH3        0x00000001UL         /**< Mode CH2CH3 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH2           0x00000002UL         /**< Mode CH2 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH4CH5        0x00000002UL         /**< Mode CH4CH5 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH6CH7        0x00000003UL         /**< Mode CH6CH7 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH3           0x00000003UL         /**< Mode CH3 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH4           0x00000004UL         /**< Mode CH4 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_DIFF0         0x00000004UL         /**< Mode DIFF0 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH5           0x00000005UL         /**< Mode CH5 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH6           0x00000006UL         /**< Mode CH6 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_CH7           0x00000007UL         /**< Mode CH7 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_TEMP          0x00000008UL         /**< Mode TEMP for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_VDDDIV3       0x00000009UL         /**< Mode VDDDIV3 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_VDD           0x0000000AUL         /**< Mode VDD for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_VSS           0x0000000BUL         /**< Mode VSS for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_VREFDIV2      0x0000000CUL         /**< Mode VREFDIV2 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_DACOUT0       0x0000000DUL         /**< Mode DACOUT0 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_DACOUT1       0x0000000EUL         /**< Mode DACOUT1 for ADC_SINGLECTRL */
#define _ADC_SINGLECTRL_SINGLESEL_ATESTIN       0x0000000FUL         /**< Mode ATESTIN for ADC_SINGLECTRL */
...
#define ADC_SINGLECTRL_SINGLEPRSEN              (0x1UL << 24)        /**< Single Sample PRS Trigger Enable */
...
#define ADC_SCANCTRL_SCANREP                    (0x1UL << 0)         /**< Scan Sequence Repetitive Mode */
...
#define ADC_SCANCTRL_SCANDIFF                   (0x1UL << 1)         /**< Scan Sequence Differential Mode */
...
#define ADC_SCANCTRL_SCANADJ                    (0x1UL << 2)         /**< Scan Sequence Result Adjustment */
...
#define ADC_SCANCTRL_SCANMASK_CH0               (0x00000001UL << 8)  /**< Shifted mode CH0 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH0CH1            (0x00000001UL << 8)  /**< Shifted mode CH0CH1 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH1               (0x00000002UL << 8)  /**< Shifted mode CH1 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH2CH3            (0x00000002UL << 8)  /**< Shifted mode CH2CH3 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH2               (0x00000004UL << 8)  /**< Shifted mode CH2 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH4CH5            (0x00000004UL << 8)  /**< Shifted mode CH4CH5 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH6CH7            (0x00000008UL << 8)  /**< Shifted mode CH6CH7 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH3               (0x00000008UL << 8)  /**< Shifted mode CH3 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH4               (0x00000010UL << 8)  /**< Shifted mode CH4 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH5               (0x00000020UL << 8)  /**< Shifted mode CH5 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH6               (0x00000040UL << 8)  /**< Shifted mode CH6 for ADC_SCANCTRL */
#define ADC_SCANCTRL_SCANMASK_CH7               (0x00000080UL << 8)  /**< Shifted mode CH7 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_DEFAULT          0x00000000UL         /**< Mode DEFAULT for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH0              0x00000001UL         /**< Mode CH0 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH0CH1           0x00000001UL         /**< Mode CH0CH1 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH1              0x00000002UL         /**< Mode CH1 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH2CH3           0x00000002UL         /**< Mode CH2CH3 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH2              0x00000004UL         /**< Mode CH2 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH4CH5           0x00000004UL         /**< Mode CH4CH5 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH6CH7           0x00000008UL         /**< Mode CH6CH7 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH3              0x00000008UL         /**< Mode CH3 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH4              0x00000010UL         /**< Mode CH4 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH5              0x00000020UL         /**< Mode CH5 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH6              0x00000040UL         /**< Mode CH6 for ADC_SCANCTRL */
#define _ADC_SCANCTRL_SCANMASK_CH7              0x00000080UL         /**< Mode CH7 for ADC_SCANCTRL */
...
#define ADC_SCANCTRL_SCANPRSEN                  (0x1UL << 24)        /**< Scan Sequence PRS Trigger Enable */
...
#define DAC_CH0CTRL_CH0EN                 (0x1UL << 0)        /**< Channel 0 Enable */
...
#define DAC_CH0CTRL_CH0REFREN             (0x1UL << 1)        /**< Channel 0 Automatic Refresh Enable */
...
#define DAC_CH0CTRL_CH0PRSEN              (0x1UL << 2)        /**< Channel 0 PRS Trigger Enable */
...
#define DAC_CH1CTRL_CH1EN                 (0x1UL << 0)        /**< Channel 1 Enable */
...
#define DAC_CH1CTRL_CH1REFREN             (0x1UL << 1)        /**< Channel 1 Automatic Refresh Enable */
...
#define DAC_CH1CTRL_CH1PRSEN              (0x1UL << 2)        /**< Channel 1 PRS Trigger Enable */
...
#define GPIO_ROUTE_SWVPEN                                 (0x1UL << 2)        /**< Serial Wire Viewer Pin Enable */
...
#define LCD_DISPCTRL_VBLEV_LEVEL0          (0x00000000UL << 18) /**< Shifted mode LEVEL0 for LCD_DISPCTRL */
#define LCD_DISPCTRL_VBLEV_LEVEL1          (0x00000001UL << 18) /**< Shifted mode LEVEL1 for LCD_DISPCTRL */
#define LCD_DISPCTRL_VBLEV_LEVEL2          (0x00000002UL << 18) /**< Shifted mode LEVEL2 for LCD_DISPCTRL */
#define LCD_DISPCTRL_VBLEV_DEFAULT         (0x00000003UL << 18) /**< Shifted mode DEFAULT for LCD_DISPCTRL */
#define LCD_DISPCTRL_VBLEV_LEVEL3          (0x00000003UL << 18) /**< Shifted mode LEVEL3 for LCD_DISPCTRL */
#define LCD_DISPCTRL_VBLEV_LEVEL4          (0x00000004UL << 18) /**< Shifted mode LEVEL4 for LCD_DISPCTRL */
#define LCD_DISPCTRL_VBLEV_LEVEL5          (0x00000005UL << 18) /**< Shifted mode LEVEL5 for LCD_DISPCTRL */
#define LCD_DISPCTRL_VBLEV_LEVEL6          (0x00000006UL << 18) /**< Shifted mode LEVEL6 for LCD_DISPCTRL */
#define LCD_DISPCTRL_VBLEV_LEVEL7          (0x00000007UL << 18) /**< Shifted mode LEVEL7 for LCD_DISPCTRL */
...
#define WDOG_CTRL_SWOSCBLOCK             (0x1UL << 6)         /**< Oscillator disabling by software block */
 ...
 * @\{
 */
/** Bit fields for EFM32G840F128_DEVINFO */
...
/**
 * @addtogroup EFM32G840F128_CALIB
 * @\{
 */
...
/**************************************************************************//**
 * @defgroup EFM32G840F128_AF_Channels EFM32G840F128 AF Channels
 * @{
 *****************************************************************************/
...
/**************************************************************************//**
 * @defgroup EFM32G840F128_AF_Ports EFM32G840F128 AF Ports
 * @{
 *****************************************************************************/
...
/**************************************************************************//**
 * @defgroup EFM32G840F128_AF_Pins EFM32G840F128 AF Pins
 * @{
 *****************************************************************************/
