...
struct FlashAlgorithm const FlashDriver = {
	...
	"Flash Algorithm for NOR",
	{
		FLASH_TYPE_ONCHIP,          		// Special the Flash Device Type
		0x64000000,                 		// Special the Device Start Address
		0x00200000,                 		// Special the Device Size in Bytes 2MB
	...
	100000,												// Time Out of FlashInit/FlashUnInit/FlashVerify/FlashBlankCheck function (in msec)
	100000,    											// Time Out of FlashProgramage  Function (in msec)
	100000,  											// Time Out of FlashEraseSector Function (in msec)
	0x30000000, 										// Time Out of FlashEraseChip   Function (in msec)
