...
void DMA1_Config()
{
	...
	DMA_InitStructure.DMA_Channel = DMA1_Channel4;
	DMA_InitStructure.DMA_PeripheralBaseAddr =   /*  Periph Address */
	DMA_InitStructure.DMA_MemoryBaseAddr = &RxBuffer[0]; /* ram Address */
	DMA_InitStructure.DMA_DIR = DMA_DIR_PeripheralSRC; /* direction */
	DMA_InitStructure.DMA_BufferSize = 64;
	DMA_InitStructure.DMA_PeripheralInc = DMA_PeripheralInc_Disable; /* Disable Incrementation */
	DMA_InitStructure.DMA_MemoryInc = DMA_MemoryInc_Enable; /* Enable RAM Incrementation */
	DMA_InitStructure.DMA_PeripheralDataSize = DMA_PeripheralDataSize_Byte;
	DMA_InitStructure.DMA_Mode = DMA_Mode_Circular; /* Cycle */
